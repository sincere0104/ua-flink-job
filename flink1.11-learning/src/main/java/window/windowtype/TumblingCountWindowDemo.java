...
/**
 * @ClassName TumblingCountWindowDemo
 * @Description TODO countWindow(long size)
 * user2,0,张三,100.0
 * user2,1,李四,100.0
 * user2,2,王五,100.0
 * user2,3,王五,100.0
...
public class TumblingCountWindowDemo {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<Double> sum = wmStream
                ...
                .countWindow(3)
                .process(new ProcessWindowFunction<Tuple4<String, Long, String, Double>, Double, String, GlobalWindow>() {
                    @Override
