...
/**
 * @ClassName TimeEvictorDemo
 * @Description TODO
 * 在窗口所有元素中找到最大时间戳 max_ts 并删除所有时间戳小于 max_ts - windowSize 的元素。
 * 我们可以理解为只保留最新 windowSize 内的元素。
 * 测试数据：
 * user2,0,张三,100.0
 * user2,1,李四,100.0
 * user2,4,王五,100.0
...
public class TimeEvictorDemo {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<Double> sum = wmStream
                ...
                // ProcessWindowFunction 触发前，删除多余的元素，只保留最近两毫秒的数据
                .evictor(TimeEvictor.of(Time.milliseconds(2)))
                // ProcessWindowFunction 触发后，删除多余的元素，我感觉几乎没有使用场景
                //.evictor(TimeEvictor.of(Time.milliseconds(2),true))
